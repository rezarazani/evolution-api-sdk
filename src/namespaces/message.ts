...
export class MessageNamespace {
    ...
    async sendText(
        ...
        const response = await this.http.post<SendTextResponse>(
    ...
    async sendStatus(
        ...
        const response = await this.http.post<SendStatusResponse>(
    ...
    async sendMedia(
        ...
        const response = await this.http.post<SendMediaResponse>(
    ...
    async sendAudio(
        ...
        const response = await this.http.post<SendAudioResponse>(
    ...
    async sendSticker(
        ...
        const response = await this.http.post<SendStickerResponse>(
    ...
    async sendLocation(
        ...
        const response = await this.http.post<SendLocationResponse>(
    ...
    async sendContact(
        ...
        const response = await this.http.post<SendContactResponse>(
    ...
    async sendReaction(
        ...
        const response = await this.http.post<SendReactionResponse>(
    ...
    async sendPoll(
        ...
        const response = await this.http.post<SendPollResponse>(
    ...
    async sendList(
        ...
        const response = await this.http.post<SendListResponse>(
    ...
    async sendButtons(
        ...
        const response = await this.http.post<SendButtonsResponse>(
